...
// 行为树仲裁与 HOLD 租约，调用 RingController 并发布 6×3 关节目标。
...
class RingControlNode {
 public:
  RingControlNode(ros::NodeHandle& nh, ros::NodeHandle& pnh);
 ...
 private:
  ...
  std::unique_ptr<RingPerceptionRos> dock_perception_;  // DockMode 依赖
